...
import { ArrowRight, Globe, Layers, MapPin, ShoppingBag, Armchair, Sofa, Lamp, Box, Palette, Truck, Gem, Ruler } from 'lucide-react';
import { PRODUCTS, ADVANTAGES } from '../constants';
...
const HomeView: React.FC<HomeViewProps> = ({ setCurrentPage, onProductClick }) => {
  const featuredProducts = PRODUCTS.slice(0, 4);

  // Generate random floating particles for the implosion effect
  const particles = Array.from({ length: 12 }).map((_, i) => {
      ...
      return (
          ...
          >
              {/* Force White Color and Larger Size */}
  ...
  return (
    <div className="animate-fade-in-up font-sans">
        {/* Full Screen Hero - Gravity Effect (Converge) */}
        ...
        {/* Advantages Grid (Source Factory) */}
        ...
        <div className="bg-white py-24 border-t border-stone-100">
             <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                    ...
                    <h2 className="text-4xl font-serif font-bold leading-tight">佛山 200+ 源头展厅<br/><span className="text-stone-400">Offline Showrooms</span></h2>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                        <div className="bg-stone-50 p-6 rounded-xl border border-stone-100 hover:border-accent transition-colors cursor-pointer group" onClick={() => setCurrentPage('design')}>
                ...
                <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                    <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1200" className="absolute inset-0 w-full h-full object-cover" alt="Showroom" />
        ...
        {/* Catalog Preview */}
        <div className="py-24 max-w-7xl mx-auto px-6 bg-[#F2F4F3]">
            <div className="flex justify-between items-end mb-12 border-b border-stone-200 pb-6">
                     ...
                     <button onClick={() => setCurrentPage('shop')} className="group text-primary hover:text-accent transition-colors flex items-center gap-2 text-sm font-bold">
                        查看完整产品库 
